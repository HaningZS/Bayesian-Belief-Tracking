#!/usr/bin/env python
"""Evaluate activation-trajectory scores over question-level split seeds."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run activation-trajectory split-seed diagnostics.")
    ...
    summary = run_activation_trajectory_split_seed_sweep(
        ...
        config=ActivationTrajectoryConfig(
    ...
    written = write_activation_trajectory_split_seed_sweep(summary, args.output_json, args.output_csv)
